...
import { productStockResolver } from './resolvers/product-stock-resolver.js';
import { productPriceResolver } from './resolvers/product-price-resolver.js';
...
expressApp.use(cors(), express.json());
const schema = makeExecutableSchema({
    typeDefs:[pcmTypeDef],
    resolvers: [productResolver, categoryResolver, productStockResolver, productPriceResolver],
});
